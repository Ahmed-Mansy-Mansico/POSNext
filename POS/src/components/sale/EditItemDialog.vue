						...
						<div>
							...
							<div class="relative h-10">
								...
								<input
									...
									min="0"
									step="0.01"
									class="w-full h-10 border border-gray-300 rounded-lg pl-16 pr-3 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
